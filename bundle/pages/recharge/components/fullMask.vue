	...
	<view class="mask  "  v-show="show">
		<view class="maskContent  " >
			...
			<view class="mask_btns center">
				<image src="../../../../static/images/closeBtn.png" class="mask_btns" mode="widthFix"
					style="width: 80rpx;height: 80rpx;" @click="confirmHandle"></image>
				<!-- <view class="mask_button mask_confirm" @click="confirmHandle" :style="{background:store.$state.contentColor}">{{t('tk_al.a_c1')}}</view> -->
			</view>
		</view>
	</view>
</template>
